...
for epoch in range(EPOCHS):
    ...
    for sentence, tags in zip(x_train,y_train):
        ...
        for sentence, tags in zip(x_test, y_test):
            ...
            entityres = calculate(sentence,predict_tags,id2word,id2tag,entityres)
    ...
    path_name = "C:\\Users\\Administrator\\PycharmProjects\\ChineseNER\\save_model\\save_model"+str(epoch)+".pkl"
    print(path_name)
    torch.save(model, path_name)
    print("save_model has been saved")
